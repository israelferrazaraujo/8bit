...
const unsigned int uScreenWidth  = 40u,    // Screen Resolution X (columns)
    ...
    while (1)
	{
        ...
        while (x--)
		{
            ...
            {             
                ...
                if      (bBoundary)                        c1 = 124; // '|'; 
                else if (uxDistanceToWall <  (uxDepth>>2)) c1 = 219; // '*'; // Very close	
                else if (uxDistanceToWall <  (uxDepth>>1)) c1 = 215; // 'X'; 
                //else if (uxDistanceToWall <  (uxDepth>>1)) c1 = 215; // 'x'; 
